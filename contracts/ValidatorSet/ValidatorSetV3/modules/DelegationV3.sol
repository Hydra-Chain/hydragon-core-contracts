...
import "./../../modules/Delegation/VestedDelegation.sol";
import "./../../modules/Staking/StateSyncer.sol";
import "./../../modules/Staking/LiquidStaking.sol";
import "./../../modules/Staking/BalanceState.sol";
import "./../../modules/Withdrawal/Withdrawal.sol";
import "./../../ValidatorSetBase.sol";
import "./../../../common/CommonStructs.sol";

abstract contract DelegationV3 is
    IDelegation,
    ValidatorSetBase,
    BalanceState,
    VestedDelegation,
    ...
    StateSyncer
{
    ...
    function _delegate(address validator, address delegator, uint256 amount) private {
        if (!validators[validator].registered) revert Unauthorized("INVALID_VALIDATOR");

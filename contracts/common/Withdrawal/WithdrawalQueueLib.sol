...
import {WithdrawalQueue, WithdrawalData} from "./IWithdrawalQueueLib.sol";
...
library WithdrawalQueueLib {
     ...
     */
    function withdrawable(WithdrawalQueue storage self) internal view returns (uint256 amount, uint256 newHead) {
